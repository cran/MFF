...
#'   \item{\code{plot.mff()}}{Visualizes weights as grouped bars or a labelled heatmap, validation scores, test scores, observed-versus-predicted values, or test-series predictions.}
